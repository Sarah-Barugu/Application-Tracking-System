...
export default function ChangePasswordScreen({navigation}) {
  return (
    ...
    <View style= {styles.container}>
      ...
      <Text style= {styles.text}>Make Sure to create something secure and you can easily remember.</Text>
    <View>
    ...
    <TouchableOpacity onPress={() => navigation.navigate('NewPassCreatedScreen')} style= {styles.btn} >
